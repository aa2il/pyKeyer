...
class CWOPEN_KEYING():
    ...
    def macros(self):
        ...
        MACROS[Key][1]     = {'Label' : 'Reply'     , 'Text' : '[CALL] TU [SERIAL] [MYNAME] '}
        ...
        MACROS[Key][5]     = {'Label' : 'S&P Reply' , 'Text' : 'TU [SERIAL] [MYNAME] '}
        ...
        MACROS[Key][9]     = {'Label' : 'My Name 2x' , 'Text' : '[MYNAME] [MYNAME] '}
        MACROS[Key][10]    = {'Label' : 'NR?'      , 'Text' : 'NR? '}
        MACROS[Key][11]    = {'Label' : 'NAME? '    , 'Text' : 'NAME? '}
        CONTEST[Key]=True
    ...
    def error_check(self):
        ...
        if not match:
            ...
            print('Name sent:',self.qth,' - received:',qth2)
