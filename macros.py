...
MACROS[Key][1]  = {'Label' : MY_CALL , 'Text' : '[MYCALL] '}
...
MACROS[Key][4]    = {'Label' : 'de '+MY_CALL , 'Text' : '[CALL] de [MYCALL] [MYCALL] '}
MACROS[Key][4+12] = {'Label' : MY_CALL    , 'Text' : '[MYCALL] '}
...
MACROS[Key][4]  = {'Label' : MY_CALL    , 'Text' : '[MYCALL] '}
...
MACROS[Key][0]     = {'Label' : 'CQ'        , 'Text' : 'CQ [MYCALL] NA '}
MACROS[Key][0+12]  = {'Label' : 'QRS '      , 'Text' : 'QRS PSE QRS '}
...
MACROS[Key][0+12]  = {'Label' : 'QRS '      , 'Text' : 'QRS PSE QRS '}
MACROS[Key][1]     = {'Label' : 'Reply'     , 'Text' : '[CALL] TU [MYNAME] [MYSTATE] '}
#MACROS[Key][2]     = {'Label' : 'TU/QRZ?'   , 'Text' : '[CALL_CHANGED] GA [NAME] 73 [MYCALL] SST [LOG]'}
...
MACROS[Key][5+12]  = {'Label' : 'S&P 2x'    , 'Text' : '[SERIAL] [SERIAL]'}
MACROS[Key][6]     = {'Label' : 'AGN?'      , 'Text' : 'AGN? '}
MACROS[Key][6+12]  = {'Label' : '? '        , 'Text' : '? '}
MACROS[Key][7]     = {'Label' : 'Log QSO'   , 'Text' : '[LOG] '}

MACROS[Key][8]     = {'Label' : 'Serial 2x' , 'Text' : '[SERIAL] [SERIAL] '}
...
MACROS[Key][8+12]  = {'Label' : MY_CALL+' 2x' , 'Text' : '[MYCALL] [MYCALL] '}
MACROS[Key][9]     = {'Label' : 'NR?'      , 'Text' : 'NR? '}
...
MACROS[Key][8]  = {'Label' : MY_CALL+' 2x'  , 'Text' : 'DE [MYCALL] [MYCALL]'}
MACROS[Key][9]  = {'Label' : 'State 2x'  , 'Text' : '[MYSTATE] [MYSTATE] '}
MACROS[Key][10] = {'Label' : 'NR?'       , 'Text' : 'NR? '}
